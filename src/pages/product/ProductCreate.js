                        ...
                        <div className="col-12 border rounded d-flex flex-wrap  ">
                            ...
                            <div className="col-12 col-12 d-flex flex-wrap justify-content-between px-xl-4 p-2">
                                ...
                                <label className="col-md-5 col-12 col-xxl-3 d-flex flex-wrap py-2">
                                    ...
                                    <input type="number" name="length" id="length" className="p-2 col-12 my-1"/>
                                </label>
                                <label className="col-md-5 col-12 col-xxl-3 d-flex flex-wrap py-2">
                                            <span className="d-flex col-12">
                                               عرض
                                           </span>
                                    <input type="number" name="width" id="width" className="p-2 col-12 my-1"/>
                                </label>
                                <label className="col-md-5 col-12 col-xxl-3 d-flex flex-wrap py-2">
                                            <span className="d-flex col-12">
                                              ارتفاع
                                           </span>
                                    <input type="number" name="height" id="height" className="p-2 col-12 my-1"/>
                                </label>
                            ...
                            <div id="panelsStayOpen-collapseTwo" className="accordion-collapse collapse show"
                                ...
                                <div className="accordion-body row justify-content-center">
                                    <div className="col-12 p-2 d-flex justify-content-between flex-wrap px-3">
                                        <label className="col-md-5 col-xxl-3 col-12 d-flex flex-wrap p-2">
                                            <span className="d-flex col-12">
                                                نام کالا
                                        ...
                                        <label className="col-md-5 col-12 d-flex  flex-wrap p-2">
                                            ...
                                            <input type="text" name="brand" id="brand" className="p-2 col-12 my-1"/>
                                        </label>
